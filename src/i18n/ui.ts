...
export const ui: Record<Locale, UIStrings> = {
  'pt-br': {
    ...
    projects: {
      title: '// projetos',
      lead: 'Um ecossistema de ferramentas para RPG de mesa — terminal retrô, painel de sessão, wiki, briefings, handouts em PDF e um compilador de sessão — um gerador de briefing classificado para clãs de milsim, e um template de terminal para o README do GitHub. Tudo autoral e aberto.',
    },
    packages: {
      title: '// libs',
  ...
  en: {
    ...
    projects: {
      title: '// projects',
      lead: 'An ecosystem of tools for tabletop RPGs — retro terminal, session panel, wiki, briefings, printable PDF handouts and a session compiler — a classified briefing generator for milsim clans, plus a terminal template for GitHub profile READMEs. All original, all open.',
    },
    packages: {
      title: '// libs',
